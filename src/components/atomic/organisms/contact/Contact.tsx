...
const Contact = () =>{
    ...
    return(
        ...
        <div className='masonry sm:masonry-sm md:masonry-md lg:px-72 px-2 mb-10'>
          {markets.map((market)=> <div key={market.market} className='bg-yellow rounded-xl lg:px-6 py-4 px-3 font-poppins lg:text-base text-xs break-inside mb-5'>
